  ...
  return (
    <div className="rounded-lg border border-secondary/40 bg-gradient-to-br from-secondary/5 to-primary/5 p-8 text-center">
      ...
      <p className="mb-4 font-body text-muted">
        Your delegate profile is incomplete and hidden by default. Profile data is frozen while a
        new delegate data source is set up, so it cannot be completed right now.
      </p>
