...
export default async function ModulePage({ params }: ModulePageProps) {
      ...
      <div className="container mx-auto max-w-4xl px-6 py-16">
        <div className="text-center">
          ...
          <div className="mt-10 rounded-lg bg-muted/50 p-14">
            <p className="font-heading text-2xl font-semibold tracking-tight text-muted">
              Coming Soon
            </p>
  ...
  return (
    <div className="container mx-auto max-w-4xl px-6 py-16">
      <h1 className="mb-8 font-heading text-4xl font-bold tracking-tight text-primary">
        {module.name}
      </h1>
      <div className="rounded-lg border border-border bg-card p-8">
        <p className="font-body text-[15px] text-muted">Module content will be implemented here.</p>
      </div>
    </div>
  );
}
