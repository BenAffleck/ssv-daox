...
describe('SSV_STRATEGY_PAYLOAD', () => {
  ...
  it('preserves the SSV vesting balance contract-call as the first sub-strategy', () => {
    ...
    expect(vesting.params.address).toBe('0xB8471180C79A0a69C7790A1CCf62e91b3c3559Bf');
  ...
  it('preserves the SSV ERC20 balance-of as the second sub-strategy', () => {
    ...
    expect(ssvErc20.params.address).toBe('0x9D65fF81a3c488d585bBfb0Bfe3c7707c7917f54');
  ...
  it('adds the cSSV ERC20 balance-of as the third sub-strategy', () => {
    ...
    expect(cssv.params.address).toBe('0xe018D31F120A637828F46aFD6c64EC099d960546');
